...
parser.add_argument('--input_folder', default='/content/gdrive/My Drive/ml/elephant_img', help='input folder')
parser.add_argument('--output_folder', default='/content/gdrive/My Drive/ml/elephant_results/rgan', help='output folder')
parser.add_argument('--inception_folder', default='/content/gdrive/My Drive/ml/elephant_results/inception', help='Inception model folder (path must exists already, model will be downloaded automatically)')
...
parser.add_argument('--extra_folder', default='/content/gdrive/My Drive/ml/elephant_results/extra', help='Folder for extra photos (different so that my dropbox does not get overwhelmed with 50k pictures)')
